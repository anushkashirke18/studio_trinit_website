...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center">
      ...
      <section className="relative w-full h-screen bg-[#34192F] bg-gradient-to-b from-background from-0% via-[#34192F] via-[1%] via-[#34192F] via-[99%] to-background to-100% overflow-hidden px-6 flex flex-col items-center justify-center">
