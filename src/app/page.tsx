        ...
        <section className="w-full px-6 md:px-12 pt-12 pb-24 flex flex-col items-end overflow-hidden">
          ...
          <div className="w-full flex justify-start mt-12 md:mt-24">
            ...
            >
              ...
              <motion.p
                variants={overlayVariants}
                className="font-dmsans font-normal text-primary text-[11pt] mt-8 max-w-2xl text-left leading-relaxed"
              >
          ...
          <div className="w-full flex justify-end mt-32 md:mt-48">
            ...
            >
              ...
              <motion.p
                variants={overlayVariants}
                className="font-dmsans font-normal text-primary text-[11pt] mt-8 max-w-2xl text-right leading-relaxed"
              >
